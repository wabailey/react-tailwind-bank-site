...
const FeatureCard = ({ icon, title, content, index }) => (
	<div className={`flex flex-row items-center p-6 rounded-2xl ${index !== features.length - 1 ? "mb-6" : "mb-0"} feature-card`}>
		...
		<div className='flex-1 flex flex-col ml-3'>
			...
			<p className='font-poppins font-normal text-dimWhite text-base mb-1'>
				{content}
			</p>
	...
	return (
		<section id='features' className={layout.section}>
			...
			<div className={layout.sectionInfo}>
				...
				<p className={`${styles.paragraph} max-w-lg mt-6`}>With a tailored solution from us, you can improve your financial life by building credit, earning rewards and saving money. But with hundreds of credit cards on the market.</p>
